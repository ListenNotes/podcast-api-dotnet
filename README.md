...
**Table of Contents**
- [Podcast API .Net Library](#podcast-api-net-library)
...
var result = client.FetchPodcastLanguages(parameters).Result;             
...
var result = client.FetchPodcastRegions(parameters).Result;             
...
parameters.Add("ids", "3302bc71139541baa46ecb27dbf6071a,68faf62be97149c280ebcc25178aa731,9cf19c590ff0484d97b18b329fed0c6a");
...
var result = client.JustListen(parameters).Result;            
...
parameters.Add("page", "2");            
parameters.Add("sort", "name_a_to_z");      
...
parameters.Add("q", "evergrand stok");
...
parameters.Add("domain_name", "nytimes.com");
...
parameters.Add("q", "Jerusalem Demsas on The Dispossessed");
